...
export default function ProjectDetailPage() {
  ...
  if (!idValid) return (
    <><TopBar /><div className="console" style={{ maxWidth: 640 }}>
  ...
  return (
    <>
      ...
      <div className="console">
        ...
        {analyzing && !ana && <div className="card"><div className="muted" style={{ fontSize: 13 }}>Reading collected data and analysing…</div></div>}

        {/* ============ HEAD-TO-HEAD VIEW ============ */}
        {view === "duel" && ana?.duel?.length >= 2 && (
          <>
            <div className="card">
              <div style={{ ...PANEL_HEAD, display: "flex", marginBottom: 8 }}><VelocityIcon />Head-to-head — two pages in parallel</div>
            ...
            {A && B && (
              <>
                ...
                <div className="card">
                  <div style={{ ...PANEL_HEAD, marginBottom: 8 }}>Engagement by day</div>
                ...
                <div className="card">
                  <div style={{ ...PANEL_HEAD, marginBottom: 4 }}>Follower trend</div>
                  {(() => {
...
{/* Leaderboard with window toggle */}
            {board.length > 0 && (
              <div className="card">
                <div className="spread" style={{ marginBottom: 2 }}>
                  <span style={PANEL_HEAD}><EyeIcon />Who&apos;s winning attention</span>
            ...
            {velo?.topics?.length > 0 ? (
              <div className="card">
                <div style={{ ...PANEL_HEAD, marginBottom: 2 }}>What the market is talking about</div>
              ...
              <div className="ops-col ops-main">
{/* Topic bubbles */}
            {topClusters.length > 2 && (
              <div className="card">
                <div className="spread" style={{ marginBottom: 2 }}>
                  <span style={PANEL_HEAD}><TrendIcon />What one topic best describes the market?</span>
            ...
            {topClusters.length > 0 && (
              <div className="card">
                <div className="spread" style={{ marginBottom: 2 }}>
                  <span style={PANEL_HEAD}><TrendIcon />Engagement clusters</span>
            ...
            {ana.page_series?.length > 1 && (() => {
              ...
              return (
                <div className="card">
                  <div style={{ ...PANEL_HEAD, display: "flex", marginBottom: 2 }}><VelocityIcon />Compare pages</div>
            ...
            {ana.top_posts?.length > 0 && (
              <div className="card">
                <div style={{ ...PANEL_HEAD, marginBottom: 10 }}>Top posts by engagement</div>
                <div className="stack" style={{ gap: 12 }}>
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 10 }}>
            ...
            <div className="card">
              <div className="spread" style={{ marginBottom: 4 }}>
                <span style={PANEL_HEAD}><EyeIcon />Market scout</span>
            ...
            {/* Sources */}
            <div className="card">
              <div style={{ ...PANEL_HEAD, marginBottom: 4 }}>Sources</div>
